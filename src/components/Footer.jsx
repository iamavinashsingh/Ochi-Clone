...
function Footer() {
  return (
    <div className='w-full h-screen p-[5vw] flex gap-[5vw] bg-zinc-900 '>
        <div className='w-1/2 h-full flex flex-col justify-between  font-["FoundersGrotesk"] '>
            <div className='heading'>
                <h1 className='text-[9vw]  leading-none -mb-[2vw] uppercase'>Eye-</h1>
                <h1 className='text-[9vw]  leading-none  uppercase'>Opening</h1>
            </div>
        ...
        <div className='w-1/2 flex flex-col justify-between h-full font-["FoundersGrotesk"]'>
            <h1 className='text-[9vw] -mt-[2vw]  uppercase'>Presentations</h1>
            <div className='dets font-["NeueMontreal"]'>
              <a className="block text-[1vw] border-b-[1px] border-zinc-200 py-[2vh]" href="#">Facebook</a>
              <a className="block text-[1vw] border-b-[1px] border-zinc-200 py-[2vh]" href="#">Instagram</a>
              <a className="block text-[1vw] border-b-[1px] border-zinc-200 py-[2vh]" href="#">LinkedIn</a>
            </div>
        </div>
    </div>
  )
